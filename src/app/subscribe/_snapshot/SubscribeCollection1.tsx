/** One SubscribeCollection1 item (Webflow CMS collection). Generated by the Webflow Cloner agent. */
export type SubscribeCollection1Item = { href_0: string; image_1: string; image_2: string; mobile_3: string };

export function SubscribeCollection1({ item }: { item: SubscribeCollection1Item }) {
  return (
