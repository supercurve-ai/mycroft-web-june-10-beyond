                          ...
                          <Link href="/frameworks/gdpr" className="fw-tile-link w-inline-block">
                            <div className="fw-dial-tile">
                              ...
                              <div data-is-ix2-target="1" className="fw-dial-lottie" data-animation-type="lottie" data-src="/lottie/6a024deb9a47cda7c321c5a3_Compliance-Dial_45.json" data-loop="0" data-direction="1" data-autoplay="0" data-renderer="svg" data-default-duration="0" data-duration="0" data-loading="eager">
                                <DotLottiePlayer src="/lottie/6a024deb9a47cda7c321c5a3_Compliance-Dial_45.json" loop={false} autoplay={false} width={500} height={500} playOnView={1250} />
                              </div>
                              <div className="body-text-small color_white font_600 underline fw_dial">
                                GDPR →
                              </div>
                          ...
                          <Link href="/frameworks/soc2" className="fw-tile-link w-inline-block">
                            <div className="fw-dial-tile">
                              ...
                              <div data-is-ix2-target="1" className="fw-dial-lottie" data-animation-type="lottie" data-src="/lottie/6a024deb4cd221655fea0562_Compliance-Dial_70.json" data-loop="0" data-direction="1" data-autoplay="0" data-renderer="svg" data-default-duration="0" data-duration="0" data-loading="eager">
                                <DotLottiePlayer src="/lottie/6a024deb4cd221655fea0562_Compliance-Dial_70.json" loop={false} autoplay={false} width={500} height={500} playOnView={1750} />
                              </div>
                              <div className="body-text-small color_white font_600 underline fw_dial">
                                SOC 2 →
                              </div>
