...
/** Section 1 of /frameworks/iso27001. Generated by the Webflow Cloner agent. */
export function FrameworksIso27001Section1() {
  return (
        ...
        <div className="container-large">
          <div className="container-flex fw_hero">
            ...
            <div className="fw-hero-circle">
              <img src="/assets/iso27-badge.svg" loading="lazy" alt="" className="fw-hero-badge-img" style={{"willChange": "transform", "transform": "translate3d(8px, 8px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)", "transformStyle": "preserve-3d"}} />
