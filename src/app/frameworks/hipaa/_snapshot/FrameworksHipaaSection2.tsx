...
/** Section 2 of /frameworks/hipaa. Generated by the Webflow Cloner agent. */
export function FrameworksHipaaSection2() {
  return (
            ...
            <div className="padding-btm large">
              <div className="product-container">
                ...
                <section id="agentic-ai" className="product-feature last-child">
                  ...
                  <div className="product-feature-img wf-reveal" style={{"willChange": "opacity, transform", "opacity": "0", "transform": "translate3d(100px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)", "transformStyle": "preserve-3d", "--wf-op-dur": "1000ms", "--wf-op-delay": "0ms", "--wf-op-ease": "cubic-bezier(0.165,0.84,0.44,1)", "--wf-tr-dur": "1000ms", "--wf-tr-delay": "0ms", "--wf-tr-ease": "cubic-bezier(0.165,0.84,0.44,1)"}}>
                    <img src="/assets/ai-policy-generator.webp" loading="lazy" width="680" sizes="(max-width: 479px) 100vw, 680px" alt="" srcSet="/assets/ai-policy-generator-p-500.webp 500w, /assets/ai-policy-generator-p-800.webp 800w, /assets/ai-policy-generator-p-1080.webp 1080w, /assets/ai-policy-generator.webp 1360w" className="fw-features-img" />
                  </div>
                </section>
              </div>
            </div>
