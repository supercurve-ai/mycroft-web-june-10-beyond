/** One HomeCollection1 item (Webflow CMS collection). Generated by the Webflow Cloner agent. */
export type HomeCollection1Item = { href_0: string; image_1: string; image_2: string; mobile_3: string };

export function HomeCollection1({ item }: { item: HomeCollection1Item }) {
  return (
