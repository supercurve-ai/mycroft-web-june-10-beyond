/** Section 4 of /about. Generated by the Webflow Cloner agent. */
              ...
              <div className="pullquote-content tint_50bw">
                <div className="container-flex pullquote_container">
                  <div className="pullquote-img-container tint_75mint">
                    <img width="215" sizes="(max-width: 479px) 100vw, 215px" alt="" src="/assets/adam-cropped-mono-img.webp" loading="lazy" srcSet="/assets/adam-cropped-mono-img-p-500.webp 500w, /assets/adam-cropped-mono-img.webp 600w" className="pullquote-img" />
                  </div>
