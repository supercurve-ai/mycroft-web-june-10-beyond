          ...
          <div className="container-flex vertical space-between">
            <div className="container-flex footer-menu">
              ...
              <div className="container-flex footer-menu-items">
                ...
                <Link href="/privacy" target="_blank" className="footer-link_v2">
                  Privacy
                </Link>
                <a href="https://status.mycroft.io/" target="_blank" className="footer-link_v2">
                  Status
                </a>
                <Link href="/ai-disclosure" target="_blank" aria-current="page" className="footer-link_v2 w--current">
                  AI Disclosure
                </Link>
              </div>
            </div>
