...
export type PartnershipsBlogPostItem = { href_0: string; image_1: string; image_2: string; mobile_3: string };
  ...
  return (
    <div role="listitem" className="_3up-blog-item w-dyn-item">
      <a href={item.href_0} className="blog-item-link w-inline-block">
        <WfImage src={item.image_1} loading="lazy" alt="" sizes="100vw" srcSet={item.image_2} className="_3up-blog-img" />
