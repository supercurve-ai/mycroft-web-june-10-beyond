        ...
        <div className="page-padding">
          ...
          <div className="container-large">
            <div className="padding-btm xl">
              ...
              <div className="container-flex vertical center">
                <a href="#hero" className="btn-large w-inline-block w--current">
                  <div className="btn-text-large">
                    Talk to our team
                  </div>
                  <img loading="lazy" src="/assets/arrow-icon-v2.svg" alt="" className="btn-arrow-large" />
                  <div className="hero-btn-shine"></div>
                </a>
              </div>
            </div>
          </div>
