/** One PartnershipsCollection1 item (Webflow CMS collection). Generated by the Webflow Cloner agent. */
export type PartnershipsCollection1Item = { href_0: string; image_1: string; image_2: string; mobile_3: string };

export function PartnershipsCollection1({ item }: { item: PartnershipsCollection1Item }) {
  return (
