                ...
                <div className="padding-btm large">
                  <div className="container-flex cs_body">
                    <div className="cs-sidebar">
                      ...
                      <div id="toc" className="cs-toc-list"></div>
                      <div className="cs-share-widget">
                        <div className="cs-toc-label share">Share</div>
                        <div className="cs-share-btns">
                          <a href="#" className="cs-share-link share-copy-btn w-inline-block" aria-label="Copy link">
                            <ShareIcon>
                          ...
                          <a data-share-linkedin="true" href="#" className="cs-share-link w-inline-block" aria-label="Share on LinkedIn">
                            <ShareIcon>
                          ...
                          <a data-share-twitter="true" href="#" target="_blank" className="cs-share-link w-inline-block" aria-label="Share on X">
                            <ShareIcon>
                          ...
                          <a data-share-facebook="true" href="#" className="cs-share-link w-inline-block" aria-label="Share on Facebook">
                            <ShareIcon>
                    ...
                    <div className="pullquote-container cs_pq">
                      <div className="container-flex align-top">
                        <div style={{ backgroundColor: accent }} className="slant-label pullquote cs_var">
                          <div className="eyebrow-large no-wrap">Client Testimonial</div>
                        </div>
                      ...
                      <div style={{ backgroundColor: accent }} className="pullquote-content cs_var">
                        <div className="container-flex pullquote_container cs_var">
                          ...
                          <div className="container-flex pullquote_right cs_var">
                            ...
                            <div className="container-flex vertical">
                              <div className="pullquote-text cs_pq">{meta.testimonial.quote}</div>
