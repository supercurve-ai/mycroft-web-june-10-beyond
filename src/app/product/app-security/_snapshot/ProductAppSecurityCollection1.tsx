/** One ProductAppSecurityCollection1 item (Webflow CMS collection). Generated by the Webflow Cloner agent. */
export type ProductAppSecurityCollection1Item = { href_0: string; image_1: string; image_2: string; mobile_3: string };

export function ProductAppSecurityCollection1({ item }: { item: ProductAppSecurityCollection1Item }) {
  return (
