/** One ProductAuditAndComplianceCollection1 item (Webflow CMS collection). Generated by the Webflow Cloner agent. */
export type ProductAuditAndComplianceCollection1Item = { href_0: string; image_1: string; image_2: string; mobile_3: string };

export function ProductAuditAndComplianceCollection1({ item }: { item: ProductAuditAndComplianceCollection1Item }) {
  return (
