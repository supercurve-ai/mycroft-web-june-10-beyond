    ...
    <div className="submenu-product scrollable-submenu">
      ...
      <div className="w-layout-grid sub-solutions-grid">
        <NavLink href="/frameworks/soc2" className="solution-tile w-inline-block" tabIndex={0} style={tileHidden}>
          <img src="/assets/badges/soc-2-badge.svg" loading="lazy" width="Auto" alt="" className="solution-icon" />
          <div>
            SOC 2
          </div>
        </NavLink>
        <NavLink href="/frameworks/gdpr" className="solution-tile w-inline-block" tabIndex={0} style={tileHidden}>
          <img src="/assets/badges/gdpr-badge.svg" loading="lazy" width="Auto" alt="" className="solution-icon" />
          <div>
            GDPR
          </div>
        </NavLink>
        <NavLink href="/frameworks/pipeda" className="solution-tile row_child w-inline-block" tabIndex={0} style={tileHidden}>
          <img src="/assets/badges/pipeda-badge.svg" loading="lazy" width="Auto" alt="" className="solution-icon" />
          <div>
            PIPEDA
          </div>
        </NavLink>
        ...
        <NavLink href="/frameworks/cmmc" className="solution-tile w-inline-block" tabIndex={0} style={tileHidden}>
          <img src="/assets/badges/cmmc-badge.svg" loading="lazy" width="Auto" alt="" className="solution-icon" />
          <div>
            CMMC
          </div>
        </NavLink>
        <NavLink href="/frameworks/fedramp" className="solution-tile w-inline-block" tabIndex={0} style={tileHidden}>
          <img src="/assets/badges/fedramp-badge.svg" loading="lazy" width="Auto" alt="" className="solution-icon" />
          <div>
            FedRAMP
          </div>
        </NavLink>
        <NavLink href="/frameworks/iso27001" className="solution-tile row_child w-inline-block" tabIndex={0} style={tileHidden}>
          <img src="/assets/badges/iso-27001-badge.svg" loading="lazy" width="Auto" alt="" className="solution-icon" />
          <div>
            ISO 27001
          </div>
        </NavLink>
        ...
        <NavLink href="/frameworks/hipaa" className="solution-tile w-inline-block" tabIndex={0} style={tileHidden}>
          <img src="/assets/badges/hipaa-badge.svg" loading="lazy" width="Auto" alt="" className="solution-icon" />
          <div>
            HIPAA
          </div>
        </NavLink>
        <NavLink href="/frameworks/cpra" className="solution-tile w-inline-block" tabIndex={0} style={tileHidden}>
          <img src="/assets/badges/crpa-badge.svg" loading="lazy" width="Auto" alt="" className="solution-icon" />
          <div>
            CPRA/CCPA
          </div>
        </NavLink>
        <NavLink href="/frameworks/iso42001" className="solution-tile last_child w-inline-block" tabIndex={0} style={tileHidden}>
          <img src="/assets/badges/iso-42001-badge.svg" loading="lazy" width="Auto" alt="" className="solution-icon" />
          <div>
            ISO42001
          </div>
        </NavLink>
      ...
      <div className="sub-link-wrapper">
        ...
        <a href="https://trust.mycroft.io/" target="_blank" className="text-link xs_link w-inline-block" tabIndex={0} style={{ alignItems: "center" }}>
          ...
          <div className="arrow-icon-small xs_link w-embed">
        ...
        <div className="submenu-mobile scrollable-submenu">
          ...
          <div className="nav-menu-ctas full_width">
            <NavLink href="/demo" className="btn-nav full_width w-inline-block">
              ...
              <img src="/assets/icons/arrow-icon-white.svg" loading="lazy" alt="" className="nav-btn-arrow" style={frozenIcon} />
            </NavLink>
        ...
        <div className="nav-outer-wrapper">
          <div className="nav-menu-wrapper">
            <NavLink href="/" className="logo-lockup w-nav-brand" aria-label="home">
              <img loading="eager" src="/assets/brand/mycroft-lockup-green-v2.svg" alt="Mycroft logo lockup" className="nav-logo-img" />
            </NavLink>
            <div className="nav-menu-links_v3">
